...
const questions = [
        {
            ...
            type: 'input',
            name: 'text',
            message: 'Enter your three characters in uppercase...',
            validate: (answer) => {
                if (answer.length > 3) {
        ...
        //color of the text
        {
            type: 'input',
            name: 'color',
            message: 'Enter your text color, you may type the name of the color or the hexadecimal number in lowercase...',
            validate: (answer) => {
